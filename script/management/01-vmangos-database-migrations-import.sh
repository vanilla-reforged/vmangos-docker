...
docker exec -i vmangos-database mariadb -u root -p$MYSQL_ROOT_PASSWORD characters < "$DOCKER_DIRECTORY/vol/core-github/sql/migrations/characters_db_updates.sql"
